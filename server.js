...
const BOT_NAME = process.env.BOT_NAME || "SUNSET - LITE";
const OWNER_NAME = process.env.OWNER_NAME || "BRYAN";
const MENU_IMAGE_URL = process.env.MENU_IMAGE_URL || "https://files.catbox.moe/quaom8.jpg";
...
const AUTO_STATUS_MSG = process.env.AUTO_STATUS_MSG || "YOUR STATUS HAS BEEN SEEN BY SUNSET - LITE 💜";
